...
const localProperties: LocalProperty[] = [
  {
    ...
    address: "Calle Hidalgo 123, Centro, Guanajuato, Guanajuato",
    latitude: 21.0161,
    longitude: -101.2546,
    bedrooms: 3,
    bathrooms: 2,
  ...
  },
  {
    ...
    address: "Avenida México 456, Zona Hotelera, Puerto Vallarta, Jalisco",
    latitude: 20.6295,
    longitude: -105.2419,
    bedrooms: 2,
    bathrooms: 2,
  ...
  },
  {
    ...
    address: "Boulevard Tecnológico KM 3.5, Huajuco, Monterrey, Nuevo León",
    latitude: 25.6856,
    longitude: -100.3161,
    bedrooms: 0,
    bathrooms: 0,
  ...
  },
  {
    ...
    address: "Carretera Morelia-Quiroga KM 8, Morelia, Michoacán",
    latitude: 19.7033,
    longitude: -101.1903,
    bedrooms: 4,
    bathrooms: 3,
  ...
  },
  {
    ...
    address: "Avenida Científica, Fraccionamiento Santa Rosa, Querétaro",
    latitude: 20.5888,
    longitude: -100.3899,
    bedrooms: 0,
    bathrooms: 0,
  ...
  },
  {
    ...
    price: 85000,
    location: "Oaxaca, OAX",
    address: "Calle Murguía 304, Centro, Oaxaca de Juárez, Oaxaca",
    latitude: 17.0627,
    longitude: -96.7236,
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    address: "Camino Viejo a Boca del Río KM 5, Veracruz",
    latitude: 19.1381,
    longitude: -96.1374,
    bedrooms: 5,
    bathrooms: 4,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="space-y-3">
                {/* Main Image */}
                {mainImage && (
                  <div className="relative w-full h-96 md:h-[500px] bg-gray-200 rounded-lg overflow-hidden flex items-center justify-center group">
                    <img
                      src={mainImage}
                      alt={property.name}
                    ...
                    {("latitude" in property && property.latitude && "longitude" in property && property.longitude) && (
                      <a
                        href={`https://www.google.com/maps/?q=${property.latitude},${property.longitude}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="absolute bottom-4 right-4 bg-white hover:bg-gray-100 text-gray-800 px-4 py-2 rounded-lg font-semibold transition-colors shadow-lg flex items-center gap-2"
                      >
